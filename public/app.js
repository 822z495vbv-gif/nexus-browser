...
h1 {
  ...
  animation: appear .7s .08s ease both;
}
...
.hero-description {
  ...
  animation: appear .7s .16s ease both;
}
...
.search-container {
  ...
  animation: appear .7s .24s ease both;
}
...
.suggestions {
  ...
  animation: appear .7s .32s ease both;
}
